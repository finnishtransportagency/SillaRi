...
public class LeluService {
    ...
    public LeluRouteGeometryResponseDTO uploadRouteGeometry(Integer routeId, MultipartFile file) throws LeluRouteNotFoundException, LeluRouteGeometryUploadException {
