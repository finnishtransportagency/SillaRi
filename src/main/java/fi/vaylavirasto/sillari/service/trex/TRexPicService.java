...
public class TRexPicService {
    ...
    public BridgeImageModel getPicFromTrex(String oid, Integer bridgeId) {
        ...
        log.debug("Got picinfo from trex: " + bridgeImageModel);
        ...
        if (bridgeImageModel != null) {
            ...
            try {
                ...
                log.error("Failed getting pic bytes from trex: " + e.getMessage());
                return null;
            }
            ...
            log.debug("picBytes: " + picBytes.length);
            ...
            log.debug("createdBridgeImage with 64: " + bridgeImageModel);
    ...
    private BridgeImageModel getPicInfo(String oid) {
        ...
        try {
            ...
            log.warn("Couldn't get bridge pics from trex. Probably no pics in trex for the bridge. " + e.getMessage());
        }
        return null;
    }
