...
public class LeluBridgeWithExcessTransportNumbersResponseDTO {
    @Schema(description = "Bridge OID in Taitorakennerekisteri", example = "1.2.246.578.1.15.105512")
    private String oid;

    @Schema(description = "Bridge identifier in Taitorakennerekisteri", example = "U-5512")
    private String identifier;

    @Schema(description = "Bridge name", example = "Maijanojan silta")
    private String name;
