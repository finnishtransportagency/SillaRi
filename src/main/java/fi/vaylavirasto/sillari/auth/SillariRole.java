...
public class SillariRole {
    ...
    private static final String SILLARI_SILLANVALVOJA = "SILLARI_SILLANVALVOJA";
    private static final String SILLARI_AJOJARJESTELIJA = "SILLARI_AJOJARJESTELIJA";
    private static final String SILLARI_KULJETTAJA = "SILLARI_KULJETTAJA";
