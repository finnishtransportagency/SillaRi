...
-- Note: rename constraint not possible with H2
...
-- bridge_image
ALTER TABLE sillari.bridge_image ADD CONSTRAINT bridge_image_bridge_id_fkey FOREIGN KEY (bridge_id) REFERENCES bridge (id) DEFERRABLE;
...
ALTER TABLE sillari.route ADD CONSTRAINT route_permit_id_fkey FOREIGN KEY (permit_id) REFERENCES permit (id) DEFERRABLE;
ALTER TABLE sillari.route ADD CONSTRAINT route_departure_address_id_fkey FOREIGN KEY (departure_address_id) REFERENCES address (id) DEFERRABLE;
ALTER TABLE sillari.route ADD CONSTRAINT route_arrival_address_id_fkey FOREIGN KEY (arrival_address_id) REFERENCES address (id) DEFERRABLE;
...
ALTER TABLE sillari.route_bridge ADD CONSTRAINT route_bridge_route_id_fkey FOREIGN KEY (route_id) REFERENCES route (id) DEFERRABLE;
...
ALTER TABLE sillari.crossing ADD CONSTRAINT crossing_route_bridge_id_fkey FOREIGN KEY (route_bridge_id) REFERENCES route_bridge (id) DEFERRABLE;

CREATE INDEX crossing_route_bridge_id ON sillari.crossing (route_bridge_id);

-- crossing_image
ALTER TABLE sillari.crossing_image ADD CONSTRAINT crossing_image_crossing_id_fkey FOREIGN KEY (crossing_id) REFERENCES crossing (id) DEFERRABLE;
...
ALTER TABLE sillari.transport ADD CONSTRAINT transport_permit_id_fkey FOREIGN KEY (permit_id) REFERENCES permit (id) DEFERRABLE;
ALTER TABLE sillari.transport ADD CONSTRAINT transport_route_id_fkey FOREIGN KEY (route_id) REFERENCES route (id) DEFERRABLE;
...
DROP SEQUENCE IF EXISTS sillari.transportsbridge_id_seq;
